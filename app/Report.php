...
class Report extends Model
{
    ...
    public static function getReportData($start, $end)
    {
        ...
        foreach ($reports as $report){
            //类型细分
            isset($reportsData[$report->source_id][$report->office_id][$report->type]['reports'][$report->type_id]['cost'])?$reportsData[$report->source_id][$report->office_id][$report->type]['reports'][$report->type_id]['cost']+=$report->cost:$reportsData[$report->source_id][$report->office_id][$report->type]['reports'][$report->type_id]['cost']=$report->cost;
