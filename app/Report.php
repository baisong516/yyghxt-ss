...
class Report extends Model
{
    ...
    public static function getReportData($start, $end)
    {
        ...
        foreach ($reports as $report){
            ...
            $reportsData[$report->source_id][$report->office_id][$report->type]['reports'][$report->type_id]['zixun_cost']=$reportsData[$report->source_id][$report->office_id][$report->type]['reports'][$report->type_id]['chat']>0?sprintf('%.2f',$reportsData[$report->source_id][$report->office_id][$report->type]['reports'][$report->type_id]['cost']/$reportsData[$report->source_id][$report->office_id][$report->type]['reports'][$report->type_id]['chat']):0;
