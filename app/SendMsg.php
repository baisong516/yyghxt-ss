...
class SendMsg extends Model
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = env('MSG_ACCESS_KEY_ID'); // AccessKeyId

        $accessKeySecret = env('MSG_ACCESS_KEY_SECRET'); // AccessKeySecret
     ...
     */
    public static function sendSms($name,$tel,$doctor,$number,$date) {
...
//        $request->setProtocol("https");
        ...
        $request->setSignName(env('MSG_CFCSYY_JSK_SIGN_NAME'));

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode(env('MSG_CFCSYY_JSK'));
