...
//            dd(Specialtran::getSpecialtransList($start,$end));
            return view('specialtran.read',[
                ...
                'monthspecialtrans'=>Specialtran::getSpecialtransList(Carbon::now()->subMonth()->startOfMonth(),Carbon::now()->subMonth()->endOfMonth()),
                'yearspecialtrans'=>Specialtran::getSpecialtransList(Carbon::now()->startOfYear(),Carbon::now()->endOfYear()),
