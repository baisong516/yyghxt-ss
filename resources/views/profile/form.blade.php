<div class="box-body">
    <div class="form-group {{empty($errors->first('realname'))?'':'has-error'}}">
        ...
        <div class="col-sm-8">
            <input type="text" id="realName" name="realname" disabled="disabled" class="form-control" placeholder="{{empty($errors->first('realname'))?'名称':$errors->first('realname')}}" value="{{isset($user)?$user->realname:old('realname')}}">
        </div>
    </div>
